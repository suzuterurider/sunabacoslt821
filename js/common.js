...
$(function () { // ここはお約束
    ...
    $("#img-change").on('click', function () {
        $("#sec4 img").attr("src", "img/thumb_01.png"); // 好きな画像を用意してください
    });
    ...
    function appendFlex() {
        ...
        $(".flex_area").append(appendedDiv); // 参考サイト https://qiita.com/nekoneko-wanwan/items/227ccad5f8cc449e91e9
    }
